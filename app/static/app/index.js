...
function loadSystemInfo() {
  _axios.default.get('/system-info').then(function (response) {
    console.log(response.data);
    var systemData = response.data;
    var cpuValueText = "".concat(systemData.cpu.percent, " %");
    document.getElementById('cpu-value').innerText = cpuValueText;
    var ramValueText = "".concat(systemData.ram.percent, " %");
    var ramTotal = formatBytes(systemData.ram.total);
    var ramUsed = formatBytes(systemData.ram.used);
    document.getElementById('ram-value').innerText = ramValueText;
    document.getElementById('ram-info').innerText = "".concat(ramUsed, " / ").concat(ramTotal);
    var diskValueText = "".concat(systemData.disk.percent, " %");
    var diskTotal = formatBytes(systemData.disk.total);
    var diskUsed = formatBytes(systemData.disk.used);
    document.getElementById('disk-value').innerText = diskValueText;
    document.getElementById('disk-info').innerText = "".concat(diskUsed, " / ").concat(diskTotal);
  });
}

window.setInterval(loadSystemInfo, 1000);
},{"axios":"node_modules/axios/index.js","./styles/index.scss":"styles/index.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
